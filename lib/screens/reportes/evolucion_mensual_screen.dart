...
class _EvolucionMensualScreenState extends State<EvolucionMensualScreen> {
  ...
  String _periodoSeleccionado = 'ultimos6meses';
  ...
  List<String> _obtenerMesesFiltrados() {
    final mesesOrdenados = _datosEvolucion['igv']?.keys.toList() ?? [];
    mesesOrdenados.sort((a, b) {
      final fechaA = _parsearMesAno(a);
      final fechaB = _parsearMesAno(b);
