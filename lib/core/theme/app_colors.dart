...
class AppColors {
  ...
  static const Color secondary = Color(0xFF2E7D32); // Verde para éxito/confirmación
  ...
  static const Color saldoFavorColor = Color(0xFF4CAF50); // Verde para saldos a favor
